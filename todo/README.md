...
| [PLAN_three_rules_from_the_creds_release.md](PLAN_three_rules_from_the_creds_release.md) | Three rules from the `dew_flow_creds_for_devs` 1.7.0 release: platform limits in the kernel's unit, generated code executed rather than string-matched, and every shipped platform built by a pull request |
